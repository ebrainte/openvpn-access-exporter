...
lazy_static! {
  ...
  pub static ref BYTES_IN: GaugeVec = register_gauge_vec!("openvpn_user_bytes_in", "Bytes in",
    &["session_id", "node", "username", "common_name", "real_ip", "vpn_ip", "location", "lat", "lon", "crowdstrike_installed", "crowdstrike_last_seen", "crowdstrike_last_check", "last_mac_address"])
